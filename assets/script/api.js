  ...
  $.ajax(settings).then(function (response) {
    ...
    for (var i = 0; i < movie.locations.length; i++) {
      ...
      if (streamingService === "Amazon Prime Video"){
        ...
        .append($("<a>").attr("href", "https://www.amazon.com/s?k=" + input + "&i=instant-video&ref=nb_sb_noss_2").text("Watch Here"));
        ...
        .append($("<a>").attr("href", "https://www.netflix.com/").text("Watch Here"));
        ...
        .append($("<a>").attr("href", "https://play.google.com/store/search?q=" + input + "&hl=en_US").text("Watch Here"));
        ...
        .append($("<a>").attr("href", "https://itunes.apple.com/us/movie").text("Watch Here"));
      }
